  ...
  public  static final class Landmark extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.Landmark> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.Landmark.class) {
              parser = PARSER;
              if (parser == null) {
  ...
  public  static final class LandmarkList extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.LandmarkList> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.LandmarkList.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class RectF extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.RectF> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.RectF.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class RectFList extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.RectFList> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.RectFList.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class Face extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.Face> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.Face.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
  ...
  public  static final class FaceList extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.my.jni.dlib.data.Messages.FaceList> parser = PARSER;
          if (parser == null) {
            synchronized (com.my.jni.dlib.data.Messages.FaceList.class) {
              parser = PARSER;
              if (parser == null) {
                parser = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                PARSER = parser;
